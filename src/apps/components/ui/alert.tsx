...
function AlertTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("col-start-2 line-clamp-1 flex h-auto min-h-4 leading-4.5 font-medium tracking-tight", className)}
      {...props}
    />
  );
}
...
function AlertAction({ className, ...props }: React.ComponentProps<"div">) {
  return <div className={cn("absolute top-2 right-2 flex items-center space-x-4", className)} {...props} />;
}
